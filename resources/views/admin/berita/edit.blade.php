...
@section('container')
    <div class="col-md-8 offset-md-2 mt-5">
        ...
        <form action="{{ route('berita.update', ['token' => $token, 'berita' => $news->id_pemberitahuan]) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror"
                    placeholder="Besok ada sesuatu..." aria-describedby="nameId" value="{{ $news->nama }}">
                ...
                <select class="form-control @error('id_pemberitahuan_category') is-invalid @enderror"
                    ...
                    @foreach ($categories as $category)
                        <option value="{{ $category->id_pemberitahuan_category }}"
                            {{ $news->category == $category->id_pemberitahuan_category ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="text" name="location" id="location"
                    class="form-control @error('location') is-invalid @enderror" aria-describedby="waktuId"
                    value="{{ $news->location }}">
            ...
            <div class="form-group">
                <input type="hidden" name="viewer" id="viewer" class="form-control" aria-describedby="viewId"
                    value="{{ $news->viewer }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="jurnal_by" id="jurnal_by"
                    class="form-control @error('jurnal_by') is-invalid @enderror" value="{{ $news->jurnal_by }}"
                    aria-describedby="jurnalId">
            ...
            <div class="form-group">
                ...
                <textarea name="text" id="texteditor" cols="30" rows="10"
                    class="form-control @error('text') is-invalid @enderror" placeholder="Isi dari news.." aria-describedby="textId">{{ $news->text }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <img class="w-100 rounded" id="preview" src="{{ asset('img/berita/' . $news->thumbnail) }}"
                        alt="">
                </div>
            </div>
