...
@section('container')
    <div class="col-md-8 offset-md-2 mt-5">
        ...
        <form action="{{ route('pengumuman.update', ['token' => $token, 'pengumuman' => $pengumuman->id_pemberitahuan]) }}"
            method="post" enctype="multipart/form-data">
            @method('patch')
            @csrf
            <div class="form-group">
                <label for="nama">Pengumuman</label>
                <input type="text" name="nama" id="nama" value="{{ $pengumuman->nama }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="target" id="target" value="{{ $pengumuman->target }}"
                ...
                <select class="form-control @error('id_pemberitahuan_category') is-invalid @enderror"
                    ...
                    @foreach ($categories as $category)
                        <option value="{{ $category->id_pemberitahuan_category }}"
                            {{ $pengumuman->category == $category->id_pemberitahuan_category ? 'selected' : '' }}>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="date" id="date" value="{{ $pengumuman->date }}"
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="time" name="time" id="time" value="{{ $pengumuman->time }}"
            ...
            <div class="form-group">
                ...
                <textarea required name="text" id="texteditor" cols="30" rows="10"
                    ...
                    aria-describedby="textId">{{ $pengumuman->text }}</textarea>
                @error('text')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <img class="w-100 rounded" id="preview" src="{{ asset('img/announcement/' . $pengumuman->thumbnail) }}"
                        alt="">
                </div>
            </div>
            <div class="form-group">
