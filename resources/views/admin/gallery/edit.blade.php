...
@section('container')
    <div class="col-md-8 offset-md-2 mt-5">
        ...
        <form action="{{ route('gallery.update', ['token' => $token, 'gallery' => $gallery->id_gallery]) }}" method="POST"
            ...
            <div class="form-group">
                ...
                <input type="text" name="gallery_title" id="gallery_title"
                    class="form-control @error('gallery_title') is-invalid @enderror" placeholder="Besok ada sesuatu..."
                    aria-describedby="nameId" value="{{ $gallery->gallery_title }}">
                ...
                <select class="form-control @error('id_category') is-invalid @enderror" name="id_category">
                    @foreach ($categories as $category)
                        <option value="{{ $category->id_category }}"
                            {{ $gallery->id_category == $category->id_category ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="text" name="gallery_location" id="gallery_location"
                    class="form-control @error('gallery_location') is-invalid @enderror" placeholder="Pangker, Pelalawan"
                    value="{{ $gallery->gallery_location }}">
            ...
            <div class="form-group">
                ...
                <textarea name="gallery_text" id="texteditor" cols="30" rows="10"
                    class="form-control @error('gallery_text') is-invalid @enderror" placeholder="Isi dari gallery.."
                    aria-describedby="textId">{{ $gallery->gallery_text }}</textarea>
            ...
            <div class="row">
                <div class="col-md-6 py-md-5 py-3">
                    <div class="form-group">
                        ...
                        <input onchange="loadFile(event)" type="file" name="gallery_file" id="image"
                ...
                <div class="col-md-6 text-center">
                    <img class="w-100 rounded" id="preview" src="{{ asset('img/gallery/' . $gallery->gallery_file) }}"
                        alt="">
                </div>
            </div>
