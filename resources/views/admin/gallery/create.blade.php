        ...
        <form action="{{ route('gallery.store', ['token' => $token]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="gallery_title" id="gallery_title"
                    class="form-control @error('gallery_title') is-invalid @enderror" value="{{ old('gallery_title') }}"
                    placeholder="Besok ada sesuatu..." aria-describedby="nameId">
            ...
            <div class="form-group">
                ...
                <select class="form-control @error('id_category') is-invalid @enderror" name="id_category">
                    @foreach ($gallery as $n)
                        <option value="{{ $n->id_category }}" {{ old('id_category') == $n->id_category ? 'selected' : '' }}>
                            {{ $n->category_name }}</option>
                    @endforeach
                </select>
                @error('id_category')
                    <p class="text-danger">{{ $message }}</p>
            ...
            <div class="form-group">
                ...
                <input type="text" name="gallery_location" id="gallery_location"
                    class="form-control @error('gallery_location') is-invalid @enderror"
                    value="{{ old('gallery_location') }}" placeholder="Pangker, Pelalawan">
            ...
            <div class="form-group">
                ...
                <textarea name="gallery_text" id="texteditor" cols="30" rows="10"
                    ...
                    aria-describedby="textId">{{ old('gallery_text') }}</textarea>
                ...
                <div class="col-md-6 py-md-5 py-3">
                    <div class="form-group">
                        ...
                        <input onchange="loadFile(event)" type="file" name="gallery_file" id="image"
                            class="form-control @error('gallery_file') is-invalid @enderror"
