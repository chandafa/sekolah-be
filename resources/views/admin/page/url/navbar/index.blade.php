            ...
            <div class="w-100 table-parent bg-white">
                <div class="row p-4">
                    <div class="col-md-8">
                        ...
                        <p class="montserrat" style="font-size: .85rem;">Daftar Navbar SMKN 1 Pangkalan
                            Kerinci({{ $dataCount }})
                        </p>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{ route('navbar.create', ['token' => $token]) }}"
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <form
                                                ...
                                                @csrf
                                                @method('delete')
                                                <input type="hidden" value="{{ $data->id }}" name="idName">
