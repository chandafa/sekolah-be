...
@section('container')
    <div class="col-md-8 offset-md-2 mt-5">
        ...
        <form
            action="{{ $method == 'insert' ? route('user.store', ['token' => $token]) : route('user.update', ['token' => $token, 'user' => $user->id_admin]) }}"
            ...
            <div class="form-group">
                ...
                <input type="text" name="email" id="email" value="{{ optional($user)->email ?? old('email') }}"
                    class="form-control @error('email') is-invalid @enderror" placeholder="Email User"
            ...
            <div class="form-group">
                ...
                <input type="password" name="password" id="password" value="{{ old('password') }}"
                    class="form-control @error('password') is-invalid @enderror" placeholder="Password User"
            ...
            <div class="form-group">
                ...
                <input type="text" name="username" id="username"
                    ...
                    class="form-control @error('username') is-invalid @enderror" placeholder="Username User"
            ...
            @if ($method == 'insert')
                <div class="form-group">
                    ...
                    <input type="text" name="token" id="token"
                        ...
                        class="form-control @error('token') is-invalid @enderror" placeholder="Token User"
                        aria-describedby="usernameId">
                    @error('token')
                        <p class="text-danger">
                            {{ $message }}
                ...
                <div class="col-md-6 py-md-5 py-3">
                    <div class="form-group">
                        ...
                        <input onchange="loadFile(event)" type="file" name="image" id="image"
                            class="form-control @error('image') is-invalid @enderror" placeholder="Pangker, Pelalawan"
