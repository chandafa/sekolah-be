...
@section('container')
    <div class="col-md-8 offset-md-2 mt-5">
        <a href="{{ route('basic.index', ['token' => $token]) }}" class="btn btn-light border-warning px-4 mb-4"><i
                class="fas fa-arrow-left"></i> Kembali</a>
        <form action="{{ route('basic.update', ['token' => $token, 'id' => $data->id]) }}" enctype="multipart/form-data"
            method="post">
            @csrf
            @method('PATCH')
            <div class="row">
                    ...
                    <div class="bg-white shadow-sm p-2 row">
                        <div class="form-group col-8">
                            ...
                            <input type="text" name="name" id="name"
                                ...
                                value="{{ $data->name }}" @if ($type === 'show') disabled @endif>
                            @error('name')
                        ...
                        <div class="form-group col-4">
                            ...
                            <input type="text" name="alias_name" id="alias_name"
                                class="form-control @error('$this->alias_name') is-invalid @enderror"
                                placeholder="alias_name" value="{{ $data->alias_name }}"
                        ...
                        <div class="form-group col-12">
                            ...
                            <input type="text" name="url" id="url"
                                ...
                                value="{{ $data->url }}" @if ($type === 'show') disabled @endif>
                            @error('url')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="row col-12">
                            @if ($type == 'edit')
                                ...
                                <div class="col-md-6 text-center">
                                    <img class="w-400 rounded" id="preview" src="{{ asset($data->logo) }}"
                                        alt="Logo">
                            ...
                            @else
                                <div class="col-md-12 text-center">
                                    <img class="w-100 rounded" id="preview" src="{{ asset($data->logo) }}"
                                        alt="Logo">
                                </div>
                            @endif
                        </div>
