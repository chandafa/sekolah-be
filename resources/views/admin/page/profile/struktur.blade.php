...
@section('title')
    <title>Struktur Organisasi | Admin Panel</title>
@endsection
                ...
                <div class="col-md-5">
                    <div class="w-100 shadow bg-white rad position-relative p-4">
                        ...
                        <form enctype="multipart/form-data" method="POST" action="">
                            ...
                            <button class="btn btn-warning shadow-warnig px-5 rounded-pill position-absolute"
                                style="right: 10px;">Submit</button>
                        </form>
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="w-100 rad bg-white p-4">
                        <h4 class="poppins mb-0">Struktur Organisasi</h4>
                        <p class="montserrat" style="font-size: .85rem;">Struktur Organisasi SMKN 1 Pangkalan Kerinci</p>
