        ...
        <form action="{{ route('jurusan.store', ['token' => $token]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="jurusan_nama" id="jurusan_nama"
                    class="form-control @error('jurusan_nama') is-invalid @enderror" placeholder="Jurusan baru..."
                    aria-describedby="nameId" value="{{ old('jurusan_nama') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="jurusan_short" id="jurusan_short"
                    class="form-control @error('jurusan_short') is-invalid @enderror" value="{{ old('jurusan_short') }}"
                    aria-describedby="waktuId" placeholder="Singkatan Jurusan...">
            ...
            <div class="form-group">
                ...
                <textarea name="jurusan_text" id="texteditor" cols="30" rows="10"
                    ...
                    aria-describedby="textId">{{ old('jurusan_text') }}</textarea>
