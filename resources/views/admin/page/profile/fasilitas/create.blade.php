        ...
        <form action="{{ route('fasilitas.store', ['token' => $token]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" name="facility_name" id="facility_name"
                    ...
                    aria-describedby="nameId" value="{{ old('facility_name') }}">
            ...
            <div class="form-group">
                ...
                <textarea name="facility_text" id="texteditor" cols="30" rows="10"
                    ...
                    aria-describedby="textId">{{ old('facility_text') }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <img class="w-100 rounded" id="preview" src="{{ asset('img/fasilitas/no_image.png') }}"
                        alt="">
                </div>
            </div>
