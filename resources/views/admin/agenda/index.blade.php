            ...
            <div class="w-100 table-parent bg-white">
                <div class="row p-4">
                    <div class="col-md-8">
                        ...
                        <p class="montserrat" style="font-size: .85rem;">Daftar Agenda SMKN 1 Pangkalan Kerinci
                            ({{ $countEvent }})
                        </p>
                    </div>
                    <div class="col-md-4 text-right">
                        <a href="{{ route('event.create', ['token' => $token]) }}"
                            class="btn-print btn btn-warning shadow-warning px-5 rounded-pill"><i class="fas fa-plus"></i>
                            Agenda Baru</a>
                        <a href="{{ route('event.category.index', ['token' => $token]) }}"
                ...
                <table class="table">
                    ...
                    <tbody>
                        @foreach ($event as $key => $data)
                            <tr>
                                <td><img src="{{ asset('img/event/' . $data->thumbnail) }}" width="120px" height="60px"
