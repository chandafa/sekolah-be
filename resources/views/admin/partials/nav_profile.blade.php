<div class="menu-profile-admin mb-4">
    <a href="{{ route('basic.index', $token) }}"
        class="<?= $profile_active == 'basic' ? 'btn my-1 btn-warning px-4 shadow-warning' : 'btn my-1 btn-light px-4 border-warning' ?>">Informasi
        Dasar</a>
    ...
    <a href="{{ route('video.index', $token) }}"
        class="<?= $profile_active == 'video' ? 'btn my-1 btn-warning px-4 shadow-warning' : 'btn my-1 btn-light px-4 border-warning' ?>">Video
        Jumbotron</a>
    <a href="{{ route('slider.index', $token) }}"
        class="<?= $profile_active == 'slider' ? 'btn my-1 btn-warning px-4 shadow-warning' : 'btn my-1 btn-light px-4 border-warning' ?>">Slider
        Keunggulan</a>
