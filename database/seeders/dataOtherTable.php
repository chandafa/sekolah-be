    ...
    public function run(): void
    {
        $data = [
            [
                ...
                'is_used' => 0,
                'type' => 'url',
                'url' => 'https://youtu.be/KTB8_szoNh8?si=G8AXFRdHGSDLfFbQ',
                'created_at' => null,
            ...
            [
                ...
                'is_used' => 1,
                'type' => 'url',
                'url' => 'https://youtu.be/3ev1LHJUJpg?si=WlbK-OlY3KHnuGpz',
                'created_at' => null,
            ...
            [
                ...
                'is_used' => 0,
                'type' => 'url',
                'url' => 'https://youtu.be/x-bem5rXqC0?si=exEgyrM6cSAH3Ng2',
                'created_at' => null,
